...
export default function QueretaroPage() {
  ...
  const fetchHoteles = async ({ servicios = [], tipos = [] } = {}, ordenSeleccionado = "") => {
    try {
      ...
      url.searchParams.append("destino", "Querétaro");
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-6 mt-8">
            <div className="hidden lg:flex flex-col gap-4 h-fit sticky top-24">
              <iframe
                title="Mapa Querétaro"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7487.7406121327!2d-100.39157371122305!3d20.588793617472758!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85d35a1d5c76b99f%3A0x9aee184d35bc7df6!2sSantiago%20de%20Quer%C3%A9taro%2C%20Qro.!5e0!3m2!1ses-419!2smx!4v1713035000000!5m2!1ses-419!2smx"
                width="100%" height="200" style={{ border: 0 }} allowFullScreen loading="lazy"
              ></iframe>
              <HotelFilterBar destino="Querétaro" onFilterChange={handleFilterChange} />
            </div>

            <section>
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                <h2 className="text-lg md:text-xl font-semibold text-gray-800 mb-2 md:mb-0">
                  Querétaro: <span className="font-bold text-blue-700">{hoteles.length}</span> alojamientos encontrados
                </h2>
