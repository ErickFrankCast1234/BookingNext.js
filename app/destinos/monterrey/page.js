...
export default function MonterreyPage() {
  ...
  const fetchHoteles = async ({ servicios = [], tipos = [] } = {}, ordenSeleccionado = "") => {
    try {
      ...
      url.searchParams.append("destino", "Monterrey");
    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-6 mt-8">
            <div className="hidden lg:flex flex-col gap-4 h-fit sticky top-24">
              <iframe
                title="Mapa Monterrey"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3584.9994279680887!2d-100.3107078253791!3d25.6866147773604!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8662958d0d95b07f%3A0x45b0f264fdc9b83e!2sMonterrey%2C%20N.L.!5e0!3m2!1ses-419!2smx!4v1713040000000!5m2!1ses-419!2smx"
                width="100%" height="200" style={{ border: 0 }} allowFullScreen loading="lazy"
              ></iframe>
              <HotelFilterBar destino="Monterrey" onFilterChange={handleFilterChange} />
            </div>

            <section>
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                <h2 className="text-lg md:text-xl font-semibold text-gray-800 mb-2 md:mb-0">
                  Monterrey: <span className="font-bold text-blue-700">{hoteles.length}</span> alojamientos encontrados
                </h2>
      ...
      <dialog id="mapa-modal" className="modal">
        <div className="modal-box p-0 overflow-hidden w-full max-w-lg">
          <iframe title="Mapa Monterrey" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3584.9994279680887!2d-100.3107078253791!3d25.6866147773604!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8662958d0d95b07f%3A0x45b0f264fdc9b83e!2sMonterrey%2C%20N.L.!5e0!3m2!1ses-419!2smx!4v1713040000000!5m2!1ses-419!2smx" width="100%" height="300" style={{ border: 0 }} allowFullScreen loading="lazy"></iframe>
