...
export default function SanMiguelPage() {
  ...
  const fetchHoteles = async ({ servicios = [], tipos = [] } = {}, ordenSeleccionado = "") => {
    try {
      ...
      url.searchParams.append("destino", "San Miguel de Allende");
  ...
  const handleFilterChange = (nuevosFiltros) => {
    ...
    document.getElementById("filtros-modal")?.close();
  };
  ...
  return (
    <>
      {/* ✅ CABECERA RESPONSIVA OMITIDA POR BREVEDAD */}
      {/* ✅ CABECERA RESPONSIVA OMITIDA POR BREVEDAD */}
      {/* ✅ CABECERA RESPONSIVA */}
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-6 mt-8">
            <div className="hidden lg:flex flex-col gap-4 h-fit sticky top-24">
              <iframe
                title="Mapa San Miguel"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3762.546555038435!2d-100.74194068454144!3d20.91441428688738!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x842aa20d3a9ed4c3%3A0x40905429cc9b9a25!2sSan%20Miguel%20de%20Allende%2C%20Gto.!5e0!3m2!1ses-419!2smx!4v1713038000000!5m2!1ses-419!2smx"
                width="100%" height="200" style={{ border: 0 }} allowFullScreen loading="lazy"
              ></iframe>
              <HotelFilterBar destino="San Miguel de Allende" onFilterChange={handleFilterChange} />
            </div>

            <section>
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                <h2 className="text-lg md:text-xl font-semibold text-gray-800 mb-2 md:mb-0">
                  San Miguel de Allende: <span className="font-bold text-blue-700">{hoteles.length}</span> alojamientos encontrados
                </h2>
