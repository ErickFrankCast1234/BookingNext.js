...
export default function PueblaPage() {
  ...
  const fetchHoteles = async ({ servicios = [], tipos = [] } = {}) => {
    try {
      ...
      url.searchParams.append("destino", "Puebla");
        ...
        <div className="flex items-center gap-4 text-white font-semibold">
          {!session ? (
            ...
            <div className="dropdown dropdown-end">
              ...
              <ul className="mt-3 z-[1] p-2 shadow menu menu-sm dropdown-content bg-white rounded-box w-52 text-black">
                <li><a>Mi cuenta</a></li>
                <li><a>Reservas</a></li>
                <li><a>Favoritos</a></li>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-6 mt-8">
            ...
            <div className="flex flex-col gap-4 h-fit sticky top-24">
              <div className="rounded-lg overflow-hidden shadow-md">
                <iframe
                  title="Mapa Puebla"
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3774.0838501954554!2d-98.20854162472484!3d18.99853115460315!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85cfc0e0fa9a0973%3A0xcbe3aabdc4207f67!2sPuebla!5e0!3m2!1ses-419!2smx!4v1713118212000!5m2!1ses-419!2smx"
                  width="100%"
                  height="200"
                  style={{ border: 0 }}
                  allowFullScreen=""
              ...
              <HotelFilterBar destino="Puebla" onFilterChange={handleFilterChange} />
            </div>
            ...
            <section>
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                <h2 className="text-lg md:text-xl font-semibold text-gray-800 mb-2 md:mb-0">
                  Puebla: <span className="font-bold text-blue-700">{hoteles.length}</span> alojamientos encontrados
                </h2>
