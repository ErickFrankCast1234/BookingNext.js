      ...
      <main className="min-h-screen bg-gray-100 pt-20">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-6 mt-8">
            {/* COLUMNA DE FILTROS Y MAPA */}
            <div className="flex flex-col gap-4 h-fit sticky top-24">
              <div className="rounded-lg overflow-hidden shadow-md">
                <iframe
                  title="Mapa Guadalajara"
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3732.382058692265!2d-103.3496091254515!3d20.67456798084751!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8428b18d9a9d8f45%3A0x939a93938e2d42f2!2sGuadalajara%2C%20Jal.!5e0!3m2!1ses-419!2smx!4v1713035555555!5m2!1ses-419!2smx"
                  width="100%"
                  height="200"
                  style={{ border: 0 }}
                  allowFullScreen=""
            ...
            <section>
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                <h2 className="text-lg md:text-xl font-semibold text-gray-800 mb-2 md:mb-0">
                  Guadalajara:{" "}
                  <span className="font-bold text-blue-700">{hoteles.length}</span> alojamientos encontrados
                </h2>

                {/* Switch Lista / Cuadrícula */}
