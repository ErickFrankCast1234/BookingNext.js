...
export default function GuadalajaraPage() {
  ...
  const fetchHoteles = async ({ servicios = [], tipos = [] } = {}, ordenSeleccionado = "") => {
    try {
      ...
      url.searchParams.append("destino", "Guadalajara");
     ...
     {/* ✅ CABECERA RESPONSIVA */}
      ...
      <main className="min-h-screen bg-gray-100 pt-18">
        ...
        <div className="flex justify-around sm:hidden my-4 px-2">
          <button className="flex items-center gap-1 px-3 py-2 bg-white text-blue-600 rounded-md font-medium shadow" onClick={() => document.getElementById("ordenar-modal")?.showModal()}>
            <SortAsc className="w-4 h-4" />
            <span className="text-sm">Ordenar</span>
          </button>
          <button className="flex items-center gap-1 px-3 py-2 bg-white text-blue-600 rounded-md font-medium shadow" onClick={() => document.getElementById("filtros-modal")?.showModal()}>
            <Filter className="w-4 h-4" />
            <span className="text-sm">Filtrar</span>
          </button>
          <button className="flex items-center gap-1 px-3 py-2 bg-white text-blue-600 rounded-md font-medium shadow" onClick={() => document.getElementById("mapa-modal")?.showModal()}>
            <MapPin className="w-4 h-4" />
            <span className="text-sm">Mapa</span>
          </button>
        </div>
        <div className="w-full border-t border-gray-300 my-2 sm:hidden"></div>
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-6 mt-8">
            <div className="hidden lg:flex flex-col gap-4 h-fit sticky top-24">
              <iframe title="Mapa Guadalajara" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3732.382058692265!2d-103.3496091254515!3d20.67456798084751!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8428b18d9a9d8f45%3A0x939a93938e2d42f2!2sGuadalajara%2C%20Jal.!5e0!3m2!1ses-419!2smx!4v1713035555555!5m2!1ses-419!2smx" width="100%" height="200" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
              <HotelFilterBar destino="Guadalajara" onFilterChange={handleFilterChange} />
            </div>
            <section>
      ...
      <dialog id="mapa-modal" className="modal">
        <div className="modal-box p-0 overflow-hidden w-full max-w-lg">
          <iframe title="Mapa Guadalajara" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3732.382058692265!2d-103.3496091254515!3d20.67456798084751!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8428b18d9a9d8f45%3A0x939a93938e2d42f2!2sGuadalajara%2C%20Jal.!5e0!3m2!1ses-419!2smx!4v1713035555555!5m2!1ses-419!2smx" width="100%" height="300" style={{ border: 0 }} allowFullScreen loading="lazy"></iframe>
          ...
          <form method="dialog" className="space-y-2">
            {opcionesOrden.map((opcion, index) => (
              <div key={index} className="flex items-center gap-2">
                <input type="radio" name="orden" id={`orden-${index}`} className="radio radio-primary" checked={orden === opcion.value} onChange={() => handleOrdenChange(opcion.value)} />
